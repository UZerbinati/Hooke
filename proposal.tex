...
The idea is to describes using the notion of a manifold and an associated Lie group action, the set of internal states of the fluid, such as orientation, polarisation or conformation.
...
I plan to extend this approach, working with J.~Málek, to obtain thermodynamically consistent continuum models for arbitrary microstructures.
    
\textbf{Properties of the Manifold} We plan to examine the impact of the manifold's geometry (curvature, topology) on the kinetic theory. In particular, I will investigate whether certain geometric conditions (e.g. convexity or curvature bounds on the manifold) allow a separation of scales on the manifold, introducing slowly-varying and rapidly-varying coordinates in the BBGKY \cite{cfmz}.
...
Furthermore, in \cite{cfmz} we showed that if the Lie group action is transitive, then the only collision invariants of the kinetic equation are the classical microscopic invariants (mass, linear momentum, generalised angular momentum and energy).
I plant to explore these algebraic implications further using the orbit-stabiliser theorem to establish the effects that symmetries of the Lie group action have on the kinetic theory of fluids with internal microstructures.
    
\textbf{Diffuse-Interface Limit:} Following ideas the work of V.~Giovangigli on diffuse-interface models \cite{diffuseinterface}, I will explore the derivation of diffuse-interface models from a kinetic description, in the context of fluids with microstructures.
...
Beyond classical angular momentum, the CFMZ kinetic theory introduces a \emph{generalized angular momentum} associated with the microstructure. I plan to investigate numerical methods that also conserve this quantity.
